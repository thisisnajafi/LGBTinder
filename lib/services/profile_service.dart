...
class ProfileService {
  ...
  /// Get profiles by job ID
  static Future<List<User>> getProfilesByJob(String jobId, {String? accessToken, int? page, int? limit}) async {
    try {
      var uri = Uri.parse(ApiConfig.getUrlWithParams(ApiConfig.profileByJob, {'jobId': jobId}));
  ...
  /// Get profiles by language ID
  static Future<List<User>> getProfilesByLanguage(String languageId, {String? accessToken, int? page, int? limit}) async {
    try {
      var uri = Uri.parse(ApiConfig.getUrlWithParams(ApiConfig.profileByLanguage, {'languageId': languageId}));
  ...
  /// Get profiles by education ID
  static Future<List<User>> getProfilesByEducation(String educationId, {String? accessToken, int? page, int? limit}) async {
    try {
      var uri = Uri.parse(ApiConfig.getUrlWithParams(ApiConfig.profileByEducation, {'educationId': educationId}));
  ...
  /// Get profiles by music genre ID
  static Future<List<User>> getProfilesByMusicGenre(String musicGenreId, {String? accessToken, int? page, int? limit}) async {
    try {
      var uri = Uri.parse(ApiConfig.getUrlWithParams(ApiConfig.profileByMusicGenre, {'musicGenreId': musicGenreId}));
  ...
  /// Get profiles by interest ID
  static Future<List<User>> getProfilesByInterest(String interestId, {String? accessToken, int? page, int? limit}) async {
    try {
      var uri = Uri.parse(ApiConfig.getUrlWithParams(ApiConfig.profileByInterest, {'interestId': interestId}));
  ...
  /// Get profiles by relation goal ID
  static Future<List<User>> getProfilesByRelationGoal(String relationGoalId, {String? accessToken, int? page, int? limit}) async {
    try {
      var uri = Uri.parse(ApiConfig.getUrlWithParams(ApiConfig.profileByRelationGoal, {'relationGoalId': relationGoalId}));
  ...
  /// Get profiles by gender ID
  static Future<List<User>> getProfilesByGender(String genderId, {String? accessToken, int? page, int? limit}) async {
    try {
      var uri = Uri.parse(ApiConfig.getUrlWithParams(ApiConfig.profileByGender, {'genderId': genderId}));
  ...
  /// Get profiles by preferred gender ID
  static Future<List<User>> getProfilesByPreferredGender(String preferredGenderId, {String? accessToken, int? page, int? limit}) async {
    try {
      var uri = Uri.parse(ApiConfig.getUrlWithParams(ApiConfig.profileByPreferredGender, {'preferredGenderId': preferredGenderId}));
